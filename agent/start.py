...
"""
def write_startup(state: AgentState, files, base_path='agent/new_project') -> str:
    """
    ...
    return 'The new project has been created, go into the agent/new_project folder to see the start.md file'
