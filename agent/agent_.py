...
from agent.new_structure import generate_new_structure
...
def generate_folder_file_structure(state: AgentState) -> dict:
    ...
    return {"new_structure": new_structure_json}
...
def generate_files(state: AgentState) -> dict:
    ...
    write_file('agent/new_project/documentation.md', rewritten_documentation)
